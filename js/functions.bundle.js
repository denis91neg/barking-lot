...
const confirmReservationDiv = document.getElementById('form-confirm-reservation'); // Get the confirmation div
...
form.addEventListener('submit', function(event) {
  ...
  // ... (Existing validation logic for check-in, check-out, guests, email) ...
